...
#[derive(Serialize)]
struct ReportConfigValueReference {
    id: String,
    name: String,
}
...
#[derive(Serialize)]
struct ReportFormatParamOption {
    value: String,
}
...
async fn feeds() -> Result<Json<FeedsResponse>, ApiError> {
...
async fn report_config_asset_from_row(
    client: &tokio_postgres::Client,
    row: &Row,
...
fn report_format_reference_from_row(row: &Row) -> ReportFormatReference {
...
fn report_format_param_option_from_row(row: &Row) -> ReportFormatParamOption {
...
fn report_format_param_from_row(
    row: &Row,
    options: Vec<ReportFormatParamOption>,
...
fn report_format_asset_from_row(
    row: &Row,
    alerts: Vec<ReportFormatReference>,
    report_configs: Vec<ReportFormatReference>,
    params: Vec<ReportFormatParamItem>,

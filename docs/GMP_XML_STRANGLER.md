...
| --- | --- | --- |
| Ready for native API proof | Low-risk read workflows with DB-owned state and existing validation. | Scope-report Hosts/CVEs/Results, report metrics, and scope-report metrics. |

...
sidecar: scope-report list, host evidence, and CVE evidence collections are
queried from gvmd/PostgreSQL and returned as typed JSON, while GMP/XML remains
available for the inherited browser/control path until that workflow is

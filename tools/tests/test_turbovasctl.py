...
class TurboVASCtlTests(unittest.TestCase):
    ...
    def test_direct_smoke_status_only_keeps_signal_without_pass_payloads(self):
        ...
        self.assertEqual(compact["details"]["finding_count"], 12)
    ...
    def test_native_tooling_state_status_only_is_chat_safe(self):
        ...
        self.assertEqual(status_only["details"]["direct_api_contract"]["openapi_marked_direct_operation_count"], 95)
        self.assertEqual(status_only["details"]["direct_api_contract"]["openapi_marked_direct_read_operation_count"], 73)
        self.assertEqual(status_only["details"]["direct_api_contract"]["openapi_marked_direct_write_control_count"], 22)
        self.assertEqual(status_only["details"]["direct_api_contract"]["non_get_openapi_marked_direct_count"], 22)
        ...
        self.assertEqual(status_only["details"]["openapi_contract"]["operation_request_body_count"], 11)
        ...
        self.assertEqual(status_only["details"]["openapi_contract"]["write_control_operation_count"], 22)
        self.assertEqual(status_only["details"]["openapi_contract"]["direct_write_control_operation_count"], 22)
    ...
    def test_native_tooling_state_tracks_direct_api_contract_alignment(self):
        ...
        self.assertEqual(contract["openapi_marked_direct_write_control_count"], 22)
        self.assertEqual(
        ...
        self.assertEqual(contract["non_get_openapi_marked_direct_count"], 22)
        self.assertEqual(
    ...
    def test_native_tooling_state_tracks_openapi_contract_alignment(self):
        ...
        self.assertEqual(contract["operation_count"], 95)
        ...
        self.assertEqual(
            ...
            ["PATCH /filters/{filter_id}", "POST /tags", "PATCH /tags/{tag_id}", "POST /tags/{tag_id}/resources", "PATCH /port-lists/{port_list_id}", "PATCH /schedules/{schedule_id}", "POST /report-configs", "PATCH /report-configs/{report_config_id}", "POST /report-configs/{report_config_id}/clone", "POST /scopes", "PATCH /scopes/{scope_id}"],
        )
        ...
        expected_inherited_still_owns_values = [
            ...
            "port-list-create-range-import-export-hard-delete",
    ...
    def test_native_api_client_contract_status_only_is_chat_safe(self):
        ...
        self.assertEqual(status_only["details"]["non_get_direct_operation_count"], 22)
        self.assertEqual(status_only["details"]["write_control_operation_count"], 22)
        self.assertEqual(status_only["details"]["direct_write_control_operation_count"], 22)
        self.assertEqual(status_only["details"]["operation_request_body_count"], 11)
    ...
    def test_native_api_migration_matrix_combines_inventory_and_openapi_metadata(self):
        ...
        self.assertEqual(result["status"], "pass")
        self.assertEqual(details["summary"]["total_rows"], 95)
        self.assertEqual(details["summary"]["openapi_operation_rows"], 95)
        self.assertEqual(details["summary"]["inventory_rows"], 95)
        self.assertEqual(details["summary"]["rows_with_checked_migration_metadata"], 95)
        self.assertEqual(details["summary"]["checked_migration_field_counts"]["x_turbovas_exposure"], 95)
        ...
        self.assertEqual(delete_tag["x_turbovas_replaces"], "tag-metadata-delete")
        ...
        self.assertEqual(tags["x_turbovas_inherited_still_owns"], "tag-security-info-filter-actions-clone-export-trash")
        ...
        self.assertEqual(tag_detail["x_turbovas_inherited_still_owns"], "tag-security-info-filter-actions-clone-export-trash")
        ...
        rows = [
            {
                ...
                "x_turbovas_inherited_still_owns": "schedule-create-calendar-export-hard-delete",
        ...
        rows = [
            {
                ...
                "x_turbovas_inherited_still_owns": "saved-filter-term-type-create-hard-delete-alert-linkage",
    ...
    def test_openapi_operation_id_generator_is_stable_and_collision_free(self):
        ...
        self.assertEqual(len(operation_ids), 95)
    ...
    def test_openapi_tracks_direct_feed_security_information_and_alert_tag_lookup_contracts(self):
        ...
        self.assertEqual(tag_resource_names["x_turbovas_values"]["x-turbovas-inherited-still-owns"], "tag-security-info-filter-actions-clone-export-trash")
...
"""
    ...
    def test_direct_native_api_write_smoke_uses_guarded_operator_and_cleans_up(self):
        ...
        self.assertEqual(checks["native-api-direct.port-list-fixture"], "pass")
        ...
        self.assertEqual([probe[0] for probe in probes], ["POST", "PATCH", "PATCH", "DELETE", "DELETE", "GET", "POST", "POST", "PATCH", "POST", "DELETE", "GET", "POST", "DELETE", "GET", "DELETE", "GET", "GET", "PATCH", "PATCH", "DELETE", "POST", "DELETE", "GET", "PATCH", "PATCH", "DELETE", "GET", "POST", "GET", "GET", "PATCH", "DELETE", "DELETE", "GET", "POST", "GET", "GET", "POST", "GET", "POST", "GET", "PATCH", "PATCH", "DELETE", "DELETE", "GET"])
        rendered = json.dumps(result, sort_keys=True)
        self.assertNotIn(token, rendered)

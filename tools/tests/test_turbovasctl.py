...
class TurboVASCtlTests(unittest.TestCase):
    ...
    def test_native_tooling_state_status_only_is_chat_safe(self):
        ...
        self.assertEqual(status_only["details"]["direct_api_contract"]["openapi_marked_direct_operation_count"], 83)
        self.assertEqual(status_only["details"]["direct_api_contract"]["openapi_marked_direct_read_operation_count"], 72)
        self.assertEqual(status_only["details"]["direct_api_contract"]["openapi_marked_direct_write_control_count"], 11)
        self.assertEqual(status_only["details"]["direct_api_contract"]["non_get_openapi_marked_direct_count"], 11)
        ...
        self.assertEqual(status_only["details"]["openapi_contract"]["operation_request_body_count"], 9)
        ...
        self.assertEqual(status_only["details"]["openapi_contract"]["write_control_operation_count"], 11)
        self.assertEqual(status_only["details"]["openapi_contract"]["direct_write_control_operation_count"], 11)
    ...
    def test_native_tooling_state_tracks_direct_api_contract_alignment(self):
        ...
        self.assertEqual(contract["openapi_marked_direct_write_control_count"], 11)
        self.assertEqual(
        ...
        self.assertEqual(contract["non_get_openapi_marked_direct_count"], 11)
        self.assertEqual(
    ...
    def test_native_tooling_state_tracks_openapi_contract_alignment(self):
        ...
        self.assertEqual(contract["operation_count"], 84)
        ...
        self.assertEqual(
            ...
            ["POST /tags", "PATCH /tags/{tag_id}", "POST /tags/{tag_id}/resources", "PATCH /port-lists/{port_list_id}", "PATCH /schedules/{schedule_id}", "POST /report-configs", "PATCH /report-configs/{report_config_id}", "POST /scopes", "PATCH /scopes/{scope_id}"],
        )
    ...
    def test_native_api_client_contract_is_generated_client_ready(self):
        ...
        self.assertEqual(details["operation_count"], 84)
        self.assertEqual(details["direct_operation_count"], 83)
        self.assertEqual(details["direct_read_operation_count"], 72)
        self.assertEqual(
            details["non_get_direct_operations"],
            ["POST /tags", "PATCH /tags/{tag_id}", "DELETE /tags/{tag_id}", "POST /tags/{tag_id}/resources", "PATCH /port-lists/{port_list_id}", "PATCH /schedules/{schedule_id}", "POST /report-configs", "PATCH /report-configs/{report_config_id}", "POST /scopes", "PATCH /scopes/{scope_id}", "DELETE /scopes/{scope_id}"],
        )
    ...
    def test_native_api_client_contract_status_only_is_chat_safe(self):
        ...
        self.assertEqual(status_only["details"]["non_get_direct_operation_count"], 11)
        self.assertEqual(status_only["details"]["write_control_operation_count"], 11)
        self.assertEqual(status_only["details"]["direct_write_control_operation_count"], 11)
        self.assertEqual(status_only["details"]["operation_request_body_count"], 9)
    ...
    def test_native_api_migration_matrix_combines_inventory_and_openapi_metadata(self):
        ...
        self.assertEqual(result["status"], "pass")
        self.assertEqual(details["summary"]["total_rows"], 84)
        self.assertEqual(details["summary"]["openapi_operation_rows"], 84)
        self.assertEqual(details["summary"]["inventory_rows"], 84)
        self.assertEqual(details["summary"]["rows_with_checked_migration_metadata"], 84)
        self.assertEqual(details["summary"]["checked_migration_field_counts"]["x_turbovas_exposure"], 84)
    ...
    def test_openapi_operation_id_generator_is_stable_and_collision_free(self):
        ...
        self.assertEqual(len(operation_ids), 84)
...
"""
    ...
    def test_direct_native_api_write_smoke_uses_guarded_operator_and_cleans_up(self):
        ...
        self.assertEqual([probe[0] for probe in probes], ["POST", "PATCH", "PATCH", "DELETE", "DELETE", "GET", "POST", "POST", "PATCH", "GET", "GET", "PATCH", "PATCH", "GET", "PATCH", "GET", "POST", "GET", "POST", "GET", "PATCH", "PATCH", "DELETE", "DELETE", "GET"])
        rendered = json.dumps(result, sort_keys=True)
        self.assertNotIn(token, rendered)
